...
/*   Updated: 2021/04/08 21:37:01 by rturcey          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void) {
	...
	testsPtr mapTests[14] = { &test_map_constr, &test_map_iterate, &test_map_empty, &test_map_oparray,
							&test_map_insert, &test_map_erase, &test_map_swap, &test_map_clear, &test_map_find,
							&test_map_count, &test_map_lowerBound, &test_map_upperBound, &test_map_equalRange, &test_map_maxSize};
